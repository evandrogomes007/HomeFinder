...
@section('title', 'Meus Imóveis — HomeFinder')
        ...
        <div class="imoveis-grid">
            @forelse($imoveis as $imovel)
                <article class="imovel-card">
                    ...
                    <div class="imovel-body">
                        ...
                        <div class="imovel-footer">
                            <div class="imovel-attrs">
                                @if($imovel->quartos)
                                    <span class="attr-pill">{{ $imovel->quartos }} Qts</span>
                                @endif
                                @if($imovel->banheiros)
                                    <span class="attr-pill">{{ $imovel->banheiros }} Ban</span>
                                @endif
                                @if($imovel->area_m2)
                            ...
                            <span style="font-size:.72rem; color:var(--gray-400); font-style:italic;">
                                {{ $imovel->created_at?->diffForHumans() }}
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="imovel-actions">
                        <a href="{{ route('imoveis.show', $imovel) }}" class="btn-action btn-action-view">
                            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                            Ver
                        </a>
                        <a href="{{ route('imoveis.edit', $imovel) }}" class="btn-action btn-action-edit">
            ...
            @empty
                <div class="empty-state">
                    ...
                    <p>
                        @if(request('tipo'))
                            Sem imóveis do tipo "{{ request('tipo') }}" publicados.
                        @else
                    ...
                    @endif
                    <a href="{{ route('imoveis.create') }}" class="btn btn-brand" style="width:auto; display:inline-flex; padding:11px 24px; margin:0;">
