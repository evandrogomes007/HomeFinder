...
<div class="publish-wrap">
    ...
    @if (isset($modoEdicao) && $modoEdicao)
    ...
    <form action="{{ isset($modoEdicao) && $modoEdicao
        ...
        <div class="section-block">
            ...
            <div class="input-row">
                <div class="form-group" style="margin-bottom:0;">
                    ...
                    <select id="tipo" name="tipo" required>
                        <option value="" disabled {{ old('tipo', $imovel->tipo ?? '') ? '' : 'selected' }}>Selecionar</option>
                        <option value="casa"        {{ old('tipo', $imovel->tipo ?? '') == 'casa'        ? 'selected' : '' }}>Casa / Moradia</option>
                        ...
                        <option value="quintal"     {{ old('tipo', $imovel->tipo ?? '') == 'quintal'     ? 'selected' : '' }}>Quintal</option>
                        <option value="comercial"   {{ old('tipo', $imovel->tipo ?? '') == 'comercial'   ? 'selected' : '' }}>Espaço Comercial</option>
                    </select>
                </div>
            ...
            <div class="form-group" style="margin-top:16px;">
                ...
                <textarea id="descricao" name="descricao"
                          ...
                          rows="4"
                          required>{{ old('descricao', $imovel->descricao ?? '') }}</textarea>
            </div>
        </div>
            ...
            <div class="input-row" style="margin-top:16px;">
                <div class="form-group" style="margin-bottom:0;">
                    ...
                    <select id="quartos" name="quartos">
                        ...
                        @for($i = 0; $i <= 8; $i++)
                            <option value="{{ $i }}" {{ old('quartos', $imovel->quartos ?? '') == $i ? 'selected' : '' }}>
                ...
                <div class="form-group" style="margin-bottom:0;">
                    ...
                    <select id="banheiros" name="banheiros">
                        <option value="">— Não se aplica</option>
                        @for($i = 1; $i <= 6; $i++)
                            <option value="{{ $i }}" {{ old('banheiros', $imovel->banheiros ?? '') == $i ? 'selected' : '' }}>
        ...
        <div class="publish-actions">
            ...
            <button type="submit" class="btn btn-brand" style="flex:1;">
                ...
                {{ isset($modoEdicao) && $modoEdicao ? 'Alterar Publicação' : 'Publicar Imóvel' }}
