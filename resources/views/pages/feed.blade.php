    ...
    <div class="imoveis-grid">
                ...
                <div class="imovel-img-wrap">
                    @if(!empty($imovel->imagens))
                        <img class="imovel-img"
                             src="{{ Storage::url($imovel->imagens[0]) }}"
                             alt="{{ $imovel->titulo }}"
                             loading="lazy">
                    @else
                    ...
                    @endif
                    <span class="imovel-tipo-badge">{{ $imovel->tipo ?? 'Imóvel' }}</span>
                </div>
        ...
        @empty
            <div class="empty-state">
                ...
                <p>Tente outra pesquisa ou <a href="{{ route('HomeFinder') }}" style="color:var(--brand);font-weight:600;">ver todos os imóveis</a>.</p>
            </div>
        @endforelse
    </div>
