<?php $__env->startSection('title', 'Publicar Imóvel — HomeFinder'); ?>
...
<div class="publish-wrap">
    ...
    <form action="<?php echo e(route('imoveis.store')); ?>" method="POST" enctype="multipart/form-data" style="max-width:760px; margin:0 auto;" novalidate>
        ...
        <div class="publish-actions">
            <a href="<?php echo e(route('HomeFinder')); ?>" class="btn btn-ghost" style="width:auto; padding:13px 28px; margin-top:0;">
                Cancelar
            </a>
...
<?php echo $__env->make('homefinder', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/evandro/Transferências/HomeFinder_v2_estrutura_imobiliaria/resources/views/pages/seller-dashboard.blade.php ENDPATH**/ ?>